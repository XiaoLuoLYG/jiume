...
> **Important:** Finishing installation does not mean the app is ready to use. You must complete model configuration first. See [Configuration](Configuration.md) ([Chinese](../zh/配置信息.md)) for model setup.
...
# https://github.com/XiaoLuoLYG/jiume/releases
```
...
- **Repository:** https://github.com/XiaoLuoLYG/jiume
- **Issues:** https://github.com/XiaoLuoLYG/jiume/issues
- **Docs:** https://github.com/XiaoLuoLYG/jiume/tree/main/docs
